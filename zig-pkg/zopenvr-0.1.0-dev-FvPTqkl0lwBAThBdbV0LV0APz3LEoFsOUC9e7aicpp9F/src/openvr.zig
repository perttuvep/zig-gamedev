...
pub fn init(application_type: ApplicationType) InitError!Self {
...
pub fn chaperone(_: Self) InitError!Chaperone {
    return try Chaperone.init();
}

pub fn compositor(_: Self) InitError!Compositor {
    return try Compositor.init();
}

pub fn applications(_: Self) InitError!Applications {
    return try Applications.init();
}

pub fn input(_: Self) InitError!Input {
    return try Input.init();
}

pub fn renderModels(_: Self) InitError!RenderModels {
...
pub const TrackedDeviceProperty = enum(i32) {
    ...
    pub fn fromType(comptime T: type) type {
        return switch (T) {
            ...
            Self.Matrix34 => TrackedDeviceProperty.Matrix34,
    ...
    pub const Array = enum(i32) {
        ...
        pub fn fromType(comptime T: type) type {
            return switch (T) {
                ...
                Self.Matrix34 => TrackedDeviceProperty.Array.Matrix34,
